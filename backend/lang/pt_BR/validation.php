...
return [
    ...
    'dimensions'           => 'O arquivo :attribute tem dimensões de imagem inválidas.',
    ...
    'max'                  => [
        ...
        'array'   => 'O campo :attribute не deve ter mais que :max itens.',
    ],
    ...
    | rápido especificar uma linha de idioma personalizada para uma regra
    ...
    */
    ...
    'custom' => [
        ...
        // Exemplo:
        // 'email' => [
        //     'unique' => 'Este e-mail já está sendo utilizado em outra conta.',
        // ],
    ],
    ...
    |--------------------------------------------------------------------------
    |
    | As seguintes linhas de idioma são usadas para trocar nossos espaços reservados
    | de atributo por algo mais amigável para o leitor, como "Endereço de E-Mail"
    ...
    */
    ...
    'attributes' => [
        ...
        'size'                  => 'Tamanho',
        // Atributos do seu projeto
        'nome_cliente'          => 'Nome do Cliente',
        'destino'               => 'Destino',
        'dt_ida'                => 'Data de Ida',
        'dt_volta'              => 'Data de Volta',
        'status'                => 'Status',
    ],
];
